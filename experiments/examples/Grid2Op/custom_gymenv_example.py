...
AGENT_NAME = "BasicCustomEnvExample"
SAVE_PATH = "./example_customEnv"
    ...
    "experiments": {
        "experiment_1": {
            ...
            "env": {
                ...
                "gymenv_class": CustomGymEnv #here we specify the custom gym env to use for the agent, for training and deployment
            },
            "action_space": {
